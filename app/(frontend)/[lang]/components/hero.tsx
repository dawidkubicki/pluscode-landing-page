 ...
 * Leave as `null` for the plain gradient look.
 */
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-[1240px] flex-1 flex-col justify-center px-5 pb-10 pt-32 sm:px-10">
        ...
        >
          {dict.headlineStart}{" "}
          <em className="italic text-lime-soft">{dict.headlineEm}</em>
          {dict.headlineEnd}
        </motion.h1>

        <motion.p
          {...rise(0.3)}
          className="mt-7 max-w-[580px] text-lg leading-[1.65] text-bone-soft sm:text-[19px]"
        >
          {dict.subtext}
        </motion.p>
