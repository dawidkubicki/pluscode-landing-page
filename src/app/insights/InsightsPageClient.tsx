...
import type { InsightForPage } from './page';

interface InsightsPageClientProps {
  featured: InsightForPage | null;
  insights: InsightForPage[];
  translations: {
    label: string;
    title: string;
    subtitle: string;
          ...
          <div className="max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto">
            ...
            >
              <Link href={`/insights/${featured.slug}`} className="group block">
                <div className={`relative aspect-video md:aspect-21/9 rounded-3xl overflow-hidden mb-6 ${featured.gradient}`}>
